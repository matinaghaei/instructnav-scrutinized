# Anonymous Artifact: InstructNav Scrutinized
...
This README is intended for blind review. Author names, the public repository
URL, and the public preprint link are intentionally omitted.
...
The citation for the submitted paper is omitted from this anonymous artifact to
preserve double-blind review. It will be restored in the camera-ready/public
version.
