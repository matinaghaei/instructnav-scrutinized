...
class GLEE_Percevior:
    def __init__(self,
                 ...
                 device = "cuda:0"):
        self.visualize_seg = visualize_seg
        self.device = device
    ...
    def perceive(self,image,confidence_threshold=0.25,area_threshold=2500):
        ...
        try:
            ...
            return pred_class[(mask_area>area_threshold) & bbox_trust],pred_masks[(mask_area>area_threshold) & bbox_trust],pred_confidence[(mask_area>area_threshold) & bbox_trust],[image]
        except:
            return [],[],[],[image]
